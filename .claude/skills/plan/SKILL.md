---
allowed-tools: AskUserQuestion, Read, Glob, Grep, Agent, Write, Edit, Bash(mkdir *), Bash(cargo check *)
description: |
...
> 1. This change affects `fynd-core/src/algorithm/` and `fynd-rpc-types/src/lib.rs`
> 2. The `Algorithm` trait doesn't need to change
> 3. ...
>

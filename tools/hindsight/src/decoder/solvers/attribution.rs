...
mod tests {
    ...
    #[test]
    fn declared_solver_with_trace_candidate() {
    ...
    #[test]
    fn unknown_solver_largest_external_call() {
    ...
    #[test]
    fn attribution_zero_value_fallback() {
    ...
    #[test]
    fn attribution_wrapped_native_frames() {

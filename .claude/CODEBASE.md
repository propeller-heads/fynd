...
| [`fynd-bench-harness`](../bench-harness/README.md) | `bench-harness/` | Runs the routing algorithms over one market and writes a report: the `algorithm_bench` and `profile` targets, the configs, the viewer. Not published |

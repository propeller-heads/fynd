...
impl MarketData {
    ...
    /// After three restarts it falls back to one guard for the full set: a feed advancing faster
...
impl MarketState {
    ...
    /// disjoint, so nothing is overwritten.
    pub fn merge_subset(&mut self, other: MarketState) {

...
| Module                | Description                                                                                                                                                                        |
|-----------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `algorithm/`          | `Algorithm` trait + built-in `MostLiquidAlgorithm`, `BellmanFordAlgorithm`, `PathFrankWolfeAlgorithm`, `SplitAlgorithm` (`split` / `split_probe`), `SplitBoundedAlgorithm`. Pluggable via associated graph types. `AlgorithmConfig` shared by built-ins |

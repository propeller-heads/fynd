...
use crate::{
    algorithm::{AlgorithmConfig, BellmanFordAlgorithm, MostLiquidAlgorithm, SplitAlgorithm},
...
pub(crate) const AVAILABLE_ALGORITHMS: &[&str] = &["most_liquid", "bellman_ford", "split"];

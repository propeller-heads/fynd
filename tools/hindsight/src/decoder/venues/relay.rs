...
//!
//! [`RelayNetting`] is the fallback for Relay transactions the declared decode (see
//! `crate::decoder::declared`) could not read — solvers whose calldata has no parser, or
//! transactions with no solver frame at all.

...
* `SplitBoundedAlgorithm` -- bounded direct, connector, and anchor-token candidate discovery plus pool-disjoint and shared-pool split allocation; gas-aware net ranking when derived token gas prices are available.

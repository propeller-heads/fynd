...
| `derived/`            | `ComputationManager` runs `SpotPriceComputation`, `TokenGasPriceComputation`, `ComponentDepthComputation` in dependency order every block. `ReadinessTracker` gates workers until data is fresh |

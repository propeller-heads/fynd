...
4. Worker calls `Algorithm::find_best_route` with a `SolveRequest` carrying its local graph, the shared market/derived data, and a `RouteFilter` saying what the caller will accept
